...
class TestView(TestCase):
    ...
    def test_post_list_with_posts(self):
        ...
        self.assertNotIn(self.tag_hello_kor.name, post_001_card.text)
        ...
        self.assertNotIn(self.tag_hello.name, post_002_card.text)
        self.assertNotIn(self.tag_hello_kor.name, post_002_card.text)
        ...
        self.assertIn(self.tag_hello_kor.name, post_003_card.text)
    ...
    def test_category_page(self):
        response = self.client.get(self.category_programming.get_absolute.url())
        self.assertEqual(response.status_code, 200)
